...
const Toast: React.FC<ToastProps> = ({ message, type = 'success', isVisible, onClose, duration = 3000 }) => {
  ...
  const baseClasses = "fixed top-20 right-4 sm:top-6 sm:right-6 z-50 px-5 py-3.5 rounded-xl shadow-card-hover flex items-center gap-3 transition-all duration-300 ease-out transform max-w-md border backdrop-blur-md";
  const typeClasses = {
