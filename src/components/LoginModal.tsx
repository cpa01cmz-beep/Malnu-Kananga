    ...
    >
      <div className="bg-white/95 dark:bg-neutral-800/95 backdrop-blur-xl rounded-xl shadow-card-hover w-full max-w-md m-4 transform transition-all duration-300 ease-out scale-95 opacity-0 animate-scale-in flex flex-col max-h-[90vh] border border-neutral-200 dark:border-neutral-700">
         <div className="flex justify-between items-center px-6 py-5 border-b border-neutral-200/90 dark:border-neutral-700">
           ...
           <button
             onClick={onClose}
             className="p-2.5 rounded-xl text-neutral-500 dark:text-neutral-400 hover:bg-neutral-100 dark:hover:bg-neutral-700 transition-all duration-200 ease-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 dark:focus:ring-offset-neutral-800 hover:scale-105"
          ...
          <div className="p-6 overflow-y-auto">
            <div className="mb-6 p-5 bg-neutral-50 dark:bg-neutral-900/50 rounded-xl border border-neutral-200/90 dark:border-neutral-700 shadow-sm">
                ...
                <p className="text-xs text-neutral-600 dark:text-neutral-400 mb-4">
                 ...
                 <div className="grid grid-cols-3 gap-2">
                    <button onClick={() => handleSimulatedLogin('student')} className="px-4 py-3 bg-white dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-600 rounded-lg text-xs sm:text-sm font-semibold hover:bg-neutral-50 dark:hover:bg-neutral-700 transition-all duration-200 ease-out focus:outline-none focus:ring-2 focus:ring-primary-500/50 focus:ring-offset-2 dark:focus:ring-offset-neutral-800 active:scale-95 shadow-sm hover:shadow-md">
                        Siswa
                    </button>
                ...
                <div className="grid grid-cols-2 gap-2 mt-2">
                    <button
                        ...
                        className="px-4 py-3 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-700 text-blue-700 dark:text-blue-300 rounded-lg text-xs font-semibold hover:bg-blue-100 dark:hover:bg-blue-900/40 transition-all duration-200 ease-out focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:ring-offset-2 dark:focus:ring-offset-neutral-800 active:scale-95 shadow-sm hover:shadow-md"
                    >
                        Guru (Staff)
                    </button>
                    <button
                        onClick={() => handleSimulatedLogin('student', 'osis')}
                        className="px-4 py-3 bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-700 text-orange-700 dark:text-orange-300 rounded-lg text-xs font-semibold hover:bg-orange-100 dark:hover:bg-orange-900/40 transition-all duration-200 ease-out focus:outline-none focus:ring-2 focus:ring-orange-500/50 focus:ring-offset-2 dark:focus:ring-offset-neutral-800 active:scale-95 shadow-sm hover:shadow-md"
                    >
                        Siswa (OSIS)
                    </button>
                </div>
