...
const PPDBSection: React.FC<PPDBSectionProps> = ({ onRegisterClick }) => {
  return (
    <section id="ppdb" className="py-24 sm:py-28 bg-gradient-to-br from-primary-50/80 via-white to-neutral-50/60 dark:from-primary-900/30 dark:via-neutral-900 dark:to-neutral-900/40">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 sm:mb-16 animate-fade-in">
          <span className="inline-flex items-center gap-2 px-4 sm:px-5 py-2.5 mb-5 sm:mb-6 rounded-full bg-primary-100/90 dark:bg-primary-900/50 border border-primary-200/80 dark:border-primary-700/80 text-primary-700 dark:text-primary-300 text-xs sm:text-sm font-bold tracking-wider uppercase animate-scale-in shadow-subtle">
            <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
            Penerimaan Peserta Didik Baru
          </span>
          <h2 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-neutral-900 dark:text-white tracking-tight mb-4 sm:mb-5 animate-fade-in-up">Bergabunglah Bersama Kami</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 sm:gap-6 mb-12 sm:mb-14">
            <div className="bg-white/95 dark:bg-neutral-800/95 p-6 sm:p-7 lg:p-8 rounded-2xl shadow-card hover:shadow-float border border-neutral-200/90 dark:border-neutral-700 text-center relative overflow-hidden group hover:-translate-y-1 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 dark:focus:ring-offset-neutral-900">
                ...
                <h3 className="text-lg sm:text-xl lg:text-2xl font-extrabold text-neutral-900 dark:text-white mb-2 sm:mb-3">Isi Formulir</h3>
            ...
            <div className="bg-white/95 dark:bg-neutral-800/95 p-6 sm:p-7 lg:p-8 rounded-2xl shadow-card hover:shadow-float border border-neutral-200/90 dark:border-neutral-700 text-center relative overflow-hidden group hover:-translate-y-1 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 dark:focus:ring-offset-neutral-900">
                ...
                <h3 className="text-lg sm:text-xl lg:text-2xl font-extrabold text-neutral-900 dark:text-white mb-2 sm:mb-3">Verifikasi Berkas</h3>
            ...
            <div className="bg-white/95 dark:bg-neutral-800/95 p-6 sm:p-7 lg:p-8 rounded-2xl shadow-card hover:shadow-float border border-neutral-200/90 dark:border-neutral-700 text-center relative overflow-hidden group hover:-translate-y-1 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 dark:focus:ring-offset-neutral-900">
                ...
                <h3 className="text-lg sm:text-xl lg:text-2xl font-extrabold text-neutral-900 dark:text-white mb-2 sm:mb-3">Wawancara & Tes</h3>
        ...
        <div className="text-center">
            <button
                ...
                className="inline-flex items-center justify-center px-8 sm:px-10 lg:px-12 py-3.5 sm:py-4 text-base sm:text-lg font-bold text-white transition-all duration-300 bg-primary-600 rounded-xl hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
            >
                Daftar Sekarang
