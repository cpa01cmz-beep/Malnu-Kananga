                    ...
                    <div className="sm:justify-self-end">
                        <h3 className="text-xl sm:text-2xl font-bold text-neutral-900 dark:text-white mb-4">Tautan Bermanfaat</h3>
                          ...
                          <div className="flex justify-center sm:justify-start gap-3 mt-6">
                             <a href="#" className="text-neutral-400 hover:text-primary-600 transition-all duration-300 ease-out p-3 rounded-lg hover:bg-primary-50 dark:hover:bg-primary-900/40 focus:outline-none focus:ring-2 focus:ring-primary-500/50 focus:ring-offset-1 dark:focus:ring-offset-neutral-800 hover:scale-110 active:scale-95" aria-label="Facebook">
                                 <span className="sr-only">Facebook</span>
                                 <FacebookIcon />
                             </a>
                             <a href="#" className="text-neutral-400 hover:text-primary-600 transition-all duration-300 ease-out p-3 rounded-lg hover:bg-primary-50 dark:hover:bg-primary-900/40 focus:outline-none focus:ring-2 focus:ring-primary-500/50 focus:ring-offset-1 dark:focus:ring-offset-neutral-800 hover:scale-110 active:scale-95" aria-label="Instagram">
                                 <span className="sr-only">Instagram</span>
                                 <InstagramIcon />
                             </a>
                             <a href="#" className="text-neutral-400 hover:text-primary-600 transition-all duration-300 ease-out p-3 rounded-lg hover:bg-primary-50 dark:hover:bg-primary-900/40 focus:outline-none focus:ring-2 focus:ring-primary-500/50 focus:ring-offset-1 dark:focus:ring-offset-neutral-800 hover:scale-110 active:scale-95" aria-label="YouTube">
