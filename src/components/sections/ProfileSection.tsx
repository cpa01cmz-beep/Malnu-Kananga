        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 lg:gap-12 items-start animate-fade-in-up">
            <div className="lg:col-span-3 text-base sm:text-lg text-neutral-700 dark:text-neutral-300 space-y-8 text-left sm:text-justify leading-[1.8]">
                ...
                <div className="flex flex-wrap gap-3.5 pt-3">
                    <span className="inline-flex items-center px-5 py-2.5 rounded-full text-sm font-semibold bg-primary-100 text-primary-700 dark:bg-primary-900/50 dark:text-primary-300 border border-primary-200/80 dark:border-primary-700/80 shadow-subtle transition-all duration-200 hover:shadow-md hover:bg-primary-200/50 dark:hover:bg-primary-900/70 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-primary-500/50 focus:ring-offset-2 dark:focus:ring-offset-neutral-800 active:scale-95">
                        Kemenag RI
                    </span>
                    <span className="inline-flex items-center px-5 py-2.5 rounded-full text-sm font-semibold bg-blue-100 text-blue-700 dark:bg-blue-900/50 dark:text-blue-300 border border-blue-200/80 dark:border-blue-700/80 shadow-subtle transition-all duration-200 hover:shadow-md hover:bg-blue-200/50 dark:hover:bg-blue-900/70 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:ring-offset-2 dark:focus:ring-offset-neutral-800 active:scale-95">
                        Kurikulum Terpadu
                    </span>
                    <span className="inline-flex items-center px-5 py-2.5 rounded-full text-sm font-semibold bg-purple-100 text-purple-700 dark:bg-purple-900/50 dark:text-purple-300 border border-purple-200/80 dark:border-purple-700/80 shadow-subtle transition-all duration-200 hover:shadow-md hover:bg-purple-200/50 dark:hover:bg-purple-900/70 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:ring-offset-2 dark:focus:ring-offset-neutral-800 active:scale-95">
                        Berakhlak Mulia
                    </span>
                </div>
            </div>
            <div className="lg:col-span-2 space-y-6">
                <div className="p-6 sm:p-7 bg-gradient-to-br from-neutral-50 to-neutral-100/80 dark:from-neutral-800 dark:to-neutral-800/80 rounded-xl shadow-card border border-neutral-200/90 dark:border-neutral-700 hover:shadow-card-hover hover:-translate-y-0.5 transition-all duration-300 ease-out focus-within:ring-2 focus-within:ring-primary-500/50">
                    <div className="flex items-center gap-3 mb-4">
                        <div className="p-3 bg-gradient-to-br from-primary-100 to-primary-200 dark:from-primary-900/60 dark:to-primary-900/80 rounded-lg shadow-subtle">
