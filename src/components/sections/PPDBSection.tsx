    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5 sm:gap-6 mb-12 sm:mb-14">
            ...
            >
                ...
                <div className={`${ICON_SIZES['card-sm']} sm:${ICON_SIZES['card-md']} lg:${ICON_SIZES['card-lg']} ${GRADIENT_CLASSES.BLUE_LIGHT} dark:from-blue-900/30 dark:to-blue-800/30 text-blue-600 dark:text-blue-400 rounded-full flex items-center justify-center mx-auto mb-5 sm:mb-6 shadow-subtle`}>
                    <DocumentTextIcon />
                </div>
            ...
            >
                ...
                <div className={`${ICON_SIZES['card-sm']} sm:${ICON_SIZES['card-md']} lg:${ICON_SIZES['card-lg']} ${GRADIENT_CLASSES.PURPLE_LIGHT} dark:from-purple-900/30 dark:to-purple-800/30 text-purple-600 dark:text-purple-400 rounded-full flex items-center justify-center mx-auto mb-5 sm:mb-6 shadow-subtle`}>
            ...
            >
                ...
                <div className={`${ICON_SIZES['card-sm']} sm:${ICON_SIZES['card-md']} lg:${ICON_SIZES['card-lg']} ${GRADIENT_CLASSES.ORANGE_LIGHT} dark:from-orange-900/30 dark:to-orange-800/30 text-orange-600 dark:text-orange-400 rounded-full flex items-center justify-center mx-auto mb-5 sm:mb-6 shadow-subtle`}>
                    <UsersIcon />
                </div>
