...
const ProgramCard: React.FC<ProgramCardProps> = ({ program }) => {
  return (
    <article className="bg-white dark:bg-neutral-800 rounded-xl shadow-card hover:shadow-card-hover border border-neutral-200/80 dark:border-neutral-700/80 transition-all duration-300 ease-out overflow-hidden h-full flex flex-col group focus:outline-none focus:ring-2 focus:ring-primary-500/50 focus:ring-offset-2 dark:focus:ring-offset-neutral-800 hover:-translate-y-0.5 hover:scale-[1.01]">
