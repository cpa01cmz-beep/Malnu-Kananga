    ...
    return (
        <main className="pt-24 min-h-screen bg-neutral-50 dark:bg-neutral-900">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <h1 className="text-2xl sm:text-3xl font-bold text-neutral-900 dark:text-white mb-8">Learning Module</h1>
                ...
                {selectedTopic && (
                    <Card variant="default" padding="lg" className="mt-8">
                        <h2 className="text-xl sm:text-2xl font-bold text-neutral-900 dark:text-white mb-4">{selectedTopic.title}</h2>
