  ...
  return (
    <section id="home" className="relative min-h-[90vh] flex items-center justify-center text-center px-4 sm:px-6 lg:px-8 pt-20 pb-16 sm:pt-28 overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto">
        <div className="inline-flex items-center gap-2.5 px-5 py-2.5 mb-8 sm:mb-10 rounded-full bg-primary-100/95 dark:bg-primary-900/50 border border-primary-200/80 dark:border-primary-700/80 backdrop-blur-md shadow-subtle animate-scale-in">
        ...
        <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-extrabold text-neutral-900 dark:text-white mb-6 sm:mb-8 lg:mb-9 tracking-tight leading-[1.05] animate-scale-in">
          MA Malnu Kananga
        </h1>
        <p className="max-w-2xl mx-auto text-base sm:text-lg md:text-xl lg:text-2xl text-neutral-600 dark:text-neutral-300 mb-10 sm:mb-12 lg:mb-14 leading-relaxed animate-fade-in font-medium">
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center animate-fade-in-up">
          <a href="#ppdb" className="inline-flex items-center justify-center bg-gradient-to-r from-primary-600 to-primary-700 text-white font-bold px-7 sm:px-8 lg:px-10 py-3.5 rounded-xl hover:from-primary-700 hover:to-primary-800 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 shadow-lg hover:shadow-xl hover:-translate-y-0.5 text-sm sm:text-base">
            Info PPDB 2025
          </a>
          <a href="#profil" className="inline-flex items-center justify-center bg-white/95 dark:bg-neutral-800/95 text-neutral-700 dark:text-neutral-200 font-bold px-7 sm:px-8 lg:px-10 py-3.5 rounded-xl border-2 border-neutral-200/90 dark:border-neutral-600 hover:border-primary-400 dark:hover:border-primary-500 hover:bg-primary-50/80 dark:hover:bg-primary-900/40 backdrop-blur-md transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 shadow-md hover:shadow-lg hover:-translate-y-0.5 text-sm sm:text-base">
            Jelajahi Profil
          </a>
        </div>
      </div>
