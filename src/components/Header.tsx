...
const navLinkClass = "text-sm sm:text-base text-neutral-700 dark:text-neutral-200 hover:text-primary-600 dark:hover:text-primary-400 transition-all duration-200 font-medium px-3 sm:px-4 py-2 rounded-lg hover:bg-neutral-100/80 dark:hover:bg-neutral-700/50 focus:outline-none focus:ring-2 focus:ring-primary-500/50 focus:ring-offset-1 dark:focus:ring-offset-neutral-800 active:scale-95";
                        ...
                        >
                           ...
                           {isLoggedIn ? (
                               <div className="hidden sm:flex items-center gap-2">
                                {userExtraRole && (
                                    <span className={`text-xs font-semibold px-3 sm:px-4 py-2 rounded-lg transition-all duration-200 hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-offset-2 dark:focus:ring-offset-neutral-800 ${
