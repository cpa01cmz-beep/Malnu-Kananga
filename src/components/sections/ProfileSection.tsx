...
const ProfileSection: React.FC = () => {
  return (
    <section id="profil" className="py-16 sm:py-20 bg-white dark:bg-neutral-800/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 animate-fade-in">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-neutral-900 dark:text-white tracking-tight">Profil Madrasah</h2>
          <p className="mt-4 text-base sm:text-lg text-neutral-600 dark:text-neutral-300 max-w-2xl mx-auto">Mengenal Lebih Dekat MA Malnu Kananga</p>
        </div>
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 items-center animate-fade-in-up">
            <div className="lg:col-span-3 text-base text-neutral-700 dark:text-neutral-300 space-y-4 text-left sm:text-justify leading-relaxed">
                <p>
            ...
            <div className="lg:col-span-2 space-y-4">
                <div className="p-6 bg-neutral-50 dark:bg-neutral-800 rounded-card-lg shadow-card border border-neutral-200 dark:border-neutral-700 hover:shadow-card-hover transition-all duration-300">
                ...
                <div className="p-6 bg-neutral-50 dark:bg-neutral-800 rounded-card-lg shadow-card border border-neutral-200 dark:border-neutral-700 hover:shadow-card-hover transition-all duration-300">
                    ...
                    <ul className="list-disc list-inside text-neutral-700 dark:text-neutral-200 space-y-2.5 text-sm">
                        <li>Penguatan pendidikan agama Islam berlandasan nilai salafiyah.</li>
