...
const NotificationAnalyticsComponent: React.FC<NotificationAnalyticsProps> = ({ analytics }) => {
  ...
  return (
    <div className="space-y-6">
      <h3 className="text-lg font-medium text-gray-900">Analytics Notifikasi</h3>
        ...
        <>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              <div className="text-2xl font-bold text-gray-600">{totalDismissed}</div>
              <div className="text-sm text-gray-600">Disingkirkan</div>
            </div>
          </div>
          ...
          {Object.keys(roleBreakdown).length > 0 && (
            <div className="bg-white border rounded-lg p-4">
              <h4 className="font-medium text-gray-900 mb-3">Distribusi Peran</h4>
                  ...
                  return (
                    <div key={role} className="flex justify-between items-center">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm text-gray-900 font-medium">{count} ({percentage}%)</span>
                      </div>
                    </div>
                  );
                })}
