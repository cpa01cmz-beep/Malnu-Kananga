...
interface PieChartDataItem extends SubjectProgress {
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <Card>
                ...
                <ResponsiveContainer width="100%" height={300}>
                  <PieChart>
                    <Pie
                      data={analytics.subjectProgress as PieChartDataItem[]}
                      cx="50%"
                      cy="50%"
                      labelLine={false}
                      label={(entry) => `${(entry as unknown as PieChartDataItem).subjectName} (${(entry as unknown as PieChartDataItem).priority})`}
                      outerRadius={80}
                      fill="#8884d8"
