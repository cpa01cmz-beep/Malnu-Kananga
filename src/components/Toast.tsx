...
const Toast: React.FC<ToastProps> = ({ message, type = 'success', isVisible, onClose, duration = TIMEOUT_CONFIG.TOAST_DEFAULT_DURATION }) => {
  ...
  const baseClasses = "fixed top-20 right-4 sm:top-6 sm:right-6 z-50 px-5 py-4 rounded-xl shadow-xl flex items-center gap-3 transition-all duration-250 ease-[cubic-bezier(0.25,0.46,0.45,0.94)] transform max-w-md border backdrop-blur-xl hover:shadow-2xl";
  const typeClasses = {
