                ...
                {analytics.recommendations.slice(0, 3).map((rec, index) => (
                  <div key={index} className="flex items-start gap-3 p-4 bg-gray-50 rounded-lg">
                    ...
                    <div className="flex-1">
                      ...
                      {rec.actionable && (
                        <button type="button" aria-label={`Lihat detail rekomendasi: ${rec.title}`} className="mt-2 text-sm text-blue-600 hover:text-blue-800 font-medium">
                          Lihat detail →
                        </button>
                      )}
                    </div>
                ...
                {analytics.recommendations.map((rec, index) => (
                  <div key={index} className="flex items-start gap-4 p-4 bg-gray-50 rounded-lg">
                    ...
                    <div className="flex-1">
                      ...
                      {rec.actionable && (
                        <button type="button" aria-label={`Lihat detail rekomendasi: ${rec.title}`} className="mt-3 text-sm text-blue-600 hover:text-blue-800 font-medium flex items-center gap-1">
