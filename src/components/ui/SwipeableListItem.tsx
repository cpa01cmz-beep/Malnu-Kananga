...
const SwipeableListItem: React.FC<SwipeableListItemProps> = ({
  ...
  const { pressProps: _pressProps } = useLongPress(longPressConfig);
  ...
  return (
    <div
      ...
      onTouchStart={deleteProps.onTouchStart as any} // eslint-disable-line @typescript-eslint/no-explicit-any
      onTouchEnd={deleteProps.onTouchEnd as any} // eslint-disable-line @typescript-eslint/no-explicit-any
    >
