      ...
      <div className="relative">
        ...
        >
          ...
          {showTooltip && value && String(value).length > 0 && (
            <span 
              className={`absolute -top-12 left-1/2 -translate-x-1/2 px-3 py-2 bg-neutral-900 dark:bg-neutral-700 text-white text-xs rounded-lg shadow-xl whitespace-nowrap pointer-events-none z-50 ${prefersReducedMotion ? 'opacity-100' : 'animate-in fade-in slide-in-from-bottom-1 duration-200'}`}
              role="tooltip"
              id="clear-tooltip"
            >
              <span className="font-medium">Bersihkan</span>
              <kbd className="ml-2 px-2 py-0.5 bg-neutral-700 dark:bg-neutral-600 rounded text-[10px] font-mono border border-neutral-600 dark:border-neutral-500" aria-hidden="true">Esc</kbd>
