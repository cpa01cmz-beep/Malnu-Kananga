...
const RelatedLinksSection: React.FC = () => {
  ...
  return (
    <section id="tautan" className="py-24 sm:py-28 bg-gradient-to-b from-white to-neutral-50/60 dark:from-neutral-800/60 dark:to-neutral-900/40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12 sm:mb-16 animate-fade-in">
                <h2 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-neutral-900 dark:text-white tracking-tight mb-4 sm:mb-5">Tautan Terkait</h2>
                <p className="text-base sm:text-lg md:text-xl text-neutral-600 dark:text-neutral-300 max-w-2xl mx-auto leading-relaxed font-medium">Akses cepat ke portal dan layanan terkait.</p>
            </div>
