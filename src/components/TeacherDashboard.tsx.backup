        ...
        {currentView === 'home' && (
            <>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 animate-fade-in-up">
                    ...
                    <button onClick={() => setCurrentView('class')} aria-label="Buka manajemen Wali Kelas" className="bg-white dark:bg-neutral-800 p-6 rounded-xl shadow-card border border-neutral-200 dark:border-neutral-700 hover:shadow-card-hover transition-all duration-300 hover:-translate-y-1 hover:scale-[1.02] group text-left focus:outline-none focus:ring-2 focus:ring-primary-500/50 focus:ring-offset-2 dark:focus:ring-offset-neutral-900">
                    ...
                    <button onClick={() => setCurrentView('grading')} aria-label="Buka Input Nilai" className="bg-white dark:bg-neutral-800 p-6 rounded-xl shadow-card border border-neutral-200 dark:border-neutral-700 hover:shadow-card-hover transition-all duration-300 hover:-translate-y-1 hover:scale-[1.02] group text-left focus:outline-none focus:ring-2 focus:ring-primary-500/50 focus:ring-offset-2 dark:focus:ring-offset-neutral-900">
                    ...
                    <button onClick={() => setCurrentView('upload')} aria-label="Buka Upload Materi" className="bg-white dark:bg-neutral-800 p-6 rounded-xl shadow-card border border-neutral-200 dark:border-neutral-700 hover:shadow-card-hover transition-all duration-300 hover:-translate-y-1 hover:scale-[1.02] group text-left focus:outline-none focus:ring-2 focus:ring-primary-500/50 focus:ring-offset-2 dark:focus:ring-offset-neutral-900">
                    ...
                    {extraRole === 'staff' && checkPermission('inventory.manage') && (
                        <button onClick={() => setCurrentView('inventory')} aria-label="Buka Inventaris" className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 p-6 rounded-xl shadow-card border border-blue-200 dark:border-blue-800 hover:shadow-card-hover transition-all duration-300 hover:-translate-y-1 hover:scale-[1.02] group text-left focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:ring-offset-2 dark:focus:ring-offset-neutral-900">
