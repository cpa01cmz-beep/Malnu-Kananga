...
const INITIAL_INVENTORY: InventoryItem[] = [
    { id: '1', itemName: 'Proyektor EPSON', category: 'Elektronik', quantity: 5, condition: 'Baik', location: 'Lab Komputer' },
    { id: '2', itemName: 'Meja Siswa', category: 'Furniture', quantity: 120, condition: 'Baik', location: 'Kelas X, XI, XII' },
    { id: '3', itemName: 'Mikroskop', category: 'Alat Lab', quantity: 10, condition: 'Rusak Ringan', location: 'Lab IPA' },
];
