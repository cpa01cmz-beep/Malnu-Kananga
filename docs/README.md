...
**Created**: 2026-01-05
**Last Updated**: 2026-01-07 (Repository cleanup - corrected file count metrics to 203/181/22)
**Version**: 2.1.0
**Status**: Active
...
- **Total Source Files**: 205 TypeScript/TSX files (181 non-test + 24 test files)
