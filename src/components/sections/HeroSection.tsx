  ...
  return (
    <section id="home" className="relative min-h-[90vh] flex items-center justify-center text-center px-4 sm:px-6 lg:px-8 pt-24 pb-16 sm:pt-28 overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto">
        <div className="inline-flex items-center gap-2.5 px-5 py-2.5 mb-8 sm:mb-10 rounded-full bg-primary-100 dark:bg-primary-900/70 border border-primary-200/80 dark:border-primary-700/80 backdrop-blur-md shadow-subtle animate-scale-in hover:shadow-md transition-shadow duration-300">
