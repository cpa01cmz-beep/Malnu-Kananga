...
const navLinkClass = "text-sm sm:text-base text-neutral-700 dark:text-neutral-200 hover:text-primary-600 dark:hover:text-primary-400 transition-all duration-200 font-medium px-3 sm:px-4 py-2 rounded-lg hover:bg-neutral-100/80 dark:hover:bg-neutral-700/50 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-1 dark:focus:ring-offset-neutral-800";
                 ...
                 <div className={`${innerNavClasses} ${isScrolled ? 'max-w-7xl mx-auto px-4' : ''}`}>
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <button
                            ...
                            className="p-2 sm:p-2.5 rounded-lg text-neutral-600 dark:text-neutral-300 hover:bg-neutral-100 dark:hover:bg-neutral-700 transition-all duration-200 ease-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 dark:focus:ring-offset-neutral-800"
                        ...
                        >
                           ...
                           {isLoggedIn ? (
                               <div className="hidden sm:flex items-center gap-2">
                                {userExtraRole && (
                                    <span className={`text-xs font-semibold px-3 sm:px-4 py-2 rounded-lg transition-all hover:opacity-80 ${
                                ...
                                <button
                                    ...
                                    className="bg-neutral-100 text-neutral-700 dark:bg-neutral-700 dark:text-neutral-300 px-3 sm:px-4 py-2 rounded-lg font-semibold text-sm hover:bg-neutral-200 dark:hover:bg-neutral-600 transition-all duration-200 ease-out focus:outline-none focus:ring-2 focus:ring-neutral-500 focus:ring-offset-2 dark:focus:ring-offset-neutral-800"
                                >
                                    {isPublicView ? 'Lihat Dashboard' : 'Lihat Website'}
                                </button>

                                <button onClick={onLogout} className="bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-300 px-3 sm:px-4 py-2 rounded-lg font-semibold text-sm hover:bg-red-200 dark:hover:bg-red-800/50 transition-all duration-200 ease-out focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 dark:focus:ring-offset-neutral-800">
                                    Logout
                                </button>
                            </div>
                          ) : (
                              <div className="hidden sm:flex items-center gap-2">
                                   <button onClick={onChatClick} className="flex items-center gap-2 bg-primary-100 text-primary-700 dark:bg-primary-900/30 dark:text-primary-300 px-3 sm:px-4 py-2 rounded-lg font-semibold text-sm hover:bg-primary-200 dark:hover:bg-primary-800/50 transition-all duration-200 ease-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 dark:focus:ring-offset-neutral-800">
                                       <ChatIcon />
                                       <span>Tanya AI</span>
                                   </button>
                            ...
                            <button onClick={() => setIsMenuOpen(!isMenuOpen)} className="md:hidden p-2 sm:p-2.5 rounded-lg text-neutral-700 dark:text-neutral-200 hover:bg-neutral-100 dark:hover:bg-neutral-700 transition-all duration-200 ease-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 dark:focus:ring-offset-neutral-800" aria-label="Buka menu">
