...
const ProfileSection: React.FC = () => {
  return (
    <section id="profil" className="py-20 sm:py-24 bg-gradient-to-b from-white to-neutral-50/50 dark:from-neutral-800/50 dark:to-neutral-900/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-lg sm:text-xl text-neutral-600 dark:text-neutral-300 max-w-2xl mx-auto leading-relaxed font-normal">Mengenal Lebih Dekat MA Malnu Kananga</p>
        </div>
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 items-center animate-fade-in-up">
            <div className="lg:col-span-3 text-base sm:text-lg text-neutral-700 dark:text-neutral-300 space-y-7 text-left sm:text-justify leading-[1.75]">
                <p>
                ...
                <div className="flex flex-wrap gap-3.5 pt-3">
                    <span className="inline-flex items-center px-5 py-2.5 rounded-full text-sm font-semibold bg-primary-100 text-primary-700 dark:bg-primary-900/40 dark:text-primary-300 border border-primary-200/60 dark:border-primary-700/60 shadow-sm">
                        Kemenag RI
                    </span>
                    <span className="inline-flex items-center px-5 py-2.5 rounded-full text-sm font-semibold bg-blue-100 text-blue-700 dark:bg-blue-900/40 dark:text-blue-300 border border-blue-200/60 dark:border-blue-700/60 shadow-sm">
                        Kurikulum Terpadu
                    </span>
                    <span className="inline-flex items-center px-5 py-2.5 rounded-full text-sm font-semibold bg-purple-100 text-purple-700 dark:bg-purple-900/40 dark:text-purple-300 border border-purple-200/60 dark:border-purple-700/60 shadow-sm">
                        Berakhlak Mulia
                    </span>
                </div>
            </div>
            <div className="lg:col-span-2 space-y-6">
                <div className="p-8 bg-gradient-to-br from-neutral-50 to-neutral-100/60 dark:from-neutral-800 dark:to-neutral-800/60 rounded-2xl shadow-card border border-neutral-200/90 dark:border-neutral-700 hover:shadow-card-hover transition-all duration-300 hover:-translate-y-1">
                    <div className="flex items-center gap-3.5 mb-5">
                        ...
                        <h3 className="text-2xl font-bold text-primary-600 dark:text-primary-400">Visi</h3>
                    </div>
                ...
                <div className="p-8 bg-gradient-to-br from-neutral-50 to-neutral-100/60 dark:from-neutral-800 dark:to-neutral-800/60 rounded-2xl shadow-card border border-neutral-200/90 dark:border-neutral-700 hover:shadow-card-hover transition-all duration-300 hover:-translate-y-1">
                    <div className="flex items-center gap-3.5 mb-5">
                        ...
                        <h3 className="text-2xl font-bold text-primary-600 dark:text-primary-400">Misi</h3>
                    </div>
                    <ul className="space-y-4 text-neutral-700 dark:text-neutral-200 text-sm sm:text-base leading-[1.75]">
