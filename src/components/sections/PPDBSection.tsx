    ...
    <section id="ppdb" className="py-20 sm:py-24 bg-gradient-to-b from-primary-50 to-white dark:from-primary-900/20 dark:to-neutral-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <div className="bg-white dark:bg-neutral-800 p-8 rounded-card-lg shadow-card border border-neutral-200 dark:border-neutral-700 text-center relative overflow-hidden group hover:-translate-y-1 transition-all duration-300 hover:shadow-card-hover">
        ...
        <div className="text-center">
            <button
                ...
                className="inline-flex items-center justify-center px-8 py-4 text-base font-bold text-white transition-all duration-200 bg-primary-600 rounded-pill hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 shadow-card hover:shadow-float transform hover:-translate-y-0.5"
            >
                Daftar Sekarang
