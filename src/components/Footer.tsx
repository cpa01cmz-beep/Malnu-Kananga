...
const Footer: React.FC<FooterProps> = ({ onDocsClick }) => {
    return (
        <footer id="kontak" className="bg-gradient-to-t from-primary-50/90 via-primary-50/50 to-transparent dark:from-primary-900/40 dark:via-primary-900/20 dark:to-transparent border-t border-neutral-200/95 dark:border-neutral-700/95">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 sm:gap-16 text-center sm:text-left">
                    ...
                    <div className="sm:justify-self-end">
                        ...
                        <div className="flex justify-center sm:justify-start gap-3 mt-8">
                            <a href="#" className="text-neutral-400 hover:text-primary-600 hover:scale-110 transition-all duration-200 p-3 rounded-lg hover:bg-primary-50/95 dark:hover:bg-primary-900/40 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-1 dark:focus:ring-offset-neutral-800" aria-label="Facebook">
                                <span className="sr-only">Facebook</span>
                                <FacebookIcon />
                            </a>
                            <a href="#" className="text-neutral-400 hover:text-primary-600 hover:scale-110 transition-all duration-200 p-3 rounded-lg hover:bg-primary-50/95 dark:hover:bg-primary-900/40 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-1 dark:focus:ring-offset-neutral-800" aria-label="Instagram">
                                <span className="sr-only">Instagram</span>
                                <InstagramIcon />
                            </a>
                            <a href="#" className="text-neutral-400 hover:text-primary-600 hover:scale-110 transition-all duration-200 p-3 rounded-lg hover:bg-primary-50/95 dark:hover:bg-primary-900/40 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-1 dark:focus:ring-offset-neutral-800" aria-label="YouTube">
