...
const HeroSection: React.FC = () => {
  return (
    <section id="home" className="relative min-h-[90vh] flex items-center justify-center text-center px-4 sm:px-6 lg:px-8 pt-20 pb-16 sm:pt-28 overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-br from-primary-50/60 via-white/50 to-primary-100/40 dark:from-primary-900/20 dark:via-neutral-900/50 dark:to-primary-900/10"></div>
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto">
        <div className="inline-flex items-center gap-2.5 px-5 py-2.5 mb-8 sm:mb-10 rounded-full bg-primary-100/95 dark:bg-primary-900/50 border border-primary-200/80 dark:border-primary-700/80 backdrop-blur-sm shadow-sm animate-scale-in">
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center animate-fade-in-up">
          ...
          <a href="#profil" className="inline-flex items-center justify-center bg-white/95 dark:bg-neutral-800/95 text-neutral-700 dark:text-neutral-200 font-semibold px-7 sm:px-8 lg:px-10 py-3.5 rounded-lg border-2 border-neutral-200/90 dark:border-neutral-600 hover:border-primary-400 dark:hover:border-primary-500 hover:bg-primary-50/80 dark:hover:bg-primary-900/40 backdrop-blur-sm transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-1 dark:focus:ring-offset-neutral-800 shadow-md hover:shadow-lg hover:-translate-y-0.5 text-sm sm:text-base">
            Jelajahi Profil
          </a>
        </div>
      </div>
